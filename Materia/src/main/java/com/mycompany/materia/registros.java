...
public class registros extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        nombre.setText("codigo de la materia");

        apellido.setText("nombre de materia");

        edad.setText("docente");

        direccion.setText("inicio");
    ...
    private void editarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editarActionPerformed
       ...
       modelo.setValueAt(id.getText(), fila, 0);
       modelo.setValueAt(campo1.getText(), fila, 1);
       modelo.setValueAt(campo2.getText(), fila, 2);
       modelo.setValueAt(campo3.getText(), fila, 3);
       modelo.setValueAt(campo4.getText(), fila, 4);   
       modelo.setValueAt(campo5.getText(), fila, 5); 
